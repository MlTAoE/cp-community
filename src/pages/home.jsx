                            ...
                            <div className=''>
                                <ul className="vault-container grid gap-5 p-5">
                                    {list.length === 0 ? (
                                        ...
                                        list.map((item, index) => (
                                            <li className="rounded-lg shadow-md p-6 bg-gray-800 text-white h-full w-full" key={index}>
                                                <div className="flex items-start mb-4">
                                                    <div className="flex-shrink-0 w-10 h-10 bg-blue-600 rounded-full mr-4 flex items-center justify-center">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
                                                            {/* A chain icon */}
                                                            <path d="M13.5442 10.4558C11.8385 8.75022 9.07316 8.75022 7.36753 10.4558L4.27922 13.5442C2.57359 15.2498 2.57359 18.0152 4.27922 19.7208C5.98485 21.4264 8.75021 21.4264 10.4558 19.7208L12 18.1766" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /> <path d="M10.4558 13.5442C12.1614 15.2498 14.9268 15.2498 16.6324 13.5442L19.7207 10.4558C21.4264 8.75021 21.4264 5.98485 19.7207 4.27922C18.0151 2.57359 15.2497 2.57359 13.5441 4.27922L12 5.82338" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                        </svg>
                                                    </div>
                                                ...
                                                <div className="mt-4 border-t border-gray-700 pt-4">
                                                    ...
                                                    >
                                                        ...
                                                        <svg
                                                            ...
                                                            className={`h-6 w-6 transform transition-transform ${showResources[index] ? 'rotate-180' : ''
                                                                }`}
                                                            fill="none"
                                                            viewBox="0 0 24 24"
                                                            stroke="currentColor"
